...
function validatepassword(){  
  ...
  if ( pw.match(document.getElementById("pwid").value)) {
                return true;
}
else{
document.getElementById("password-error").innerHTML = "Password mismatch";
 return false;
  }
}  
</script>
...
function checkConfirmPassowrd(){
	var pass = document.getElementById("pwid").value;
	var cpass = document.getElementById("cpassword").value;
	
	if(pass === cpass){
		document.getElementById("password-error").innerHTML = "";
	} else {
		document.getElementById("password-error").innerHTML = "Password is not equal to Confirm Password";
...
body {
	...
	background-image: url("<%=request.getContextPath()%>/img/bgi4.jpg");
...
<body>
	<div class="signup-form">
		<form action="<%=request.getContextPath()%>/signup/customer" method="post">
			...
			<div class="form-group">
				<input type="password" class="form-control" name="cpassword"
					id="cpassword" placeholder="Confirm Password" required="required"
					onChange="validatePassword()"> <span id="password-error"></span>
			</div>
			<div class="form-group">
           ...
           <div class="form-group">
			...
			<textarea id="address" name="address" rows="4" cols="93" placeholder="Address"  required="required"></textarea>
			</div>
		...
		<div class="text-center" style="color:#fff;">
			Already have an account? <a
				href="<%=request.getContextPath()%>/customerlogin.jsp" style="color:#fff;">Log in</a>
		</div>
	</div>
</body>
</html>